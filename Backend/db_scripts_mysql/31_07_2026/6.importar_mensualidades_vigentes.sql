-- Convertido automáticamente desde db_scripts/31_07_2026/6.importar_mensualidades_vigentes.sql
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000328: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000343: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000344: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000516: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000518: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000521: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000522: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000525: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000526: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000529: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000535: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000536: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000537: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000540: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000543: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000545: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000546: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000548: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000550: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000551: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000552: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000555: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000556: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000557: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000558: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000559: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000562: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000563: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000565: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000571: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000572: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000573: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000581: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000584: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000585: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000586: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000587: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000588: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000592: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000593: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000594: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000595: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000596: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000597: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000598: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000599: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000600: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000608: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000609: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000611: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000614: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000616: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000617: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000621: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000623: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000628: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000631: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000632: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000633: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000634: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000636: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000638: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000639: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000640: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000641: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000642: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000643: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000644: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000648: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000649: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000653: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000654: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000655: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000657: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000658: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000659: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000660: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000661: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000666: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000667: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000668: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000669: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000670: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000671: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000676: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000677: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000679: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000681: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000682: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000683: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000684: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000686: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000690: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000691: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000697: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000699: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000700: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000704: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000707: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000709: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000710: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000712: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000714: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000716: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000719: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000722: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000726: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000729: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000730: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000734: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000738: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000739: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000740: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000742: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000743: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000744: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000746: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000747: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000752: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000753: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000754: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000755: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000757: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000762: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000763: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000764: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000765: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000766: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000767: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000768: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000770: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000771: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000772: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000775: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000776: ', @M); 
...
BEGIN
    ...
    SELECT
        ...
        NULL, NULL, N'Activo'
    FROM [PLAN] p WHERE p.IDPLAN = N'PLN001';
    SELECT 'OK MEM000777: insertado (usuario no estudiante)';
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000781: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000782: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000783: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000784: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000785: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000786: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000787: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000788: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000791: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000792: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000794: ', @M); 
...
BEGIN
    ...
    EXEC usp_mensualidad_insertar
        ...
        @Resultado          = @R OUTPUT,
        @Mensaje            = @M OUTPUT;
    IF @R = 1 SELECT CONCAT('OK MEM000795: ', @M);
