-- ============================================================================
-- Membresía: estado Activo/Vencido, default Activo, fecha registro — MySQL 8
...
main: BEGIN
    ...
    IF p_EliminacionFisica = 1 THEN
        ...
        SET p_Resultado = 1; SET p_Mensaje = 'Membresía eliminada permanentemente.';
        LEAVE main;
    END IF;

    UPDATE MEMBRESIA SET ESTADO = 'Inactivo' WHERE IDMEMBRESIA = p_Id;
    SET p_Resultado = 1; SET p_Mensaje = 'Membresía desactivada.';
END$$

DELIMITER ;

SELECT 'Membresía: estado Activo/Vencido, default Activo, fecha registro automática.' AS info;
