-- Convertido automáticamente desde db_scripts/06_07_2026/3.alter_usp_asistencia_informe_vence.sql
-- MySQL 8 — Academia 3.0

USE `AcademiaDB`;

/* ============================================================================
   Alter: columna VENCE (fecha fin de última membresía) en informe asistencias
   Ejecutar después de 2.usp_asistencia_informe.sql
   Fecha: 06/07/2026
   ============================================================================ */
...
SELECT 'usp_asistencia_informe actualizado: columna FECHA_VENCE (VENCE).';
END$$
