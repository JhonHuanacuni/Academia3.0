-- Convertido automáticamente desde db_scripts/08_07_2026/2.usp_asistencia_informe_filtro_estado.sql
...
SELECT 'usp_asistencia_informe: filtro opcional p_EstadoUsuario agregado.';
END$$
