-- Convertido automáticamente desde db_scripts/08_07_2026/1.usp_asistencia_informe_filtro_plan.sql
-- MySQL 8 — Academia 3.0

USE `AcademiaDB`;

/* ============================================================================
   Alter: filtro opcional por plan (@IDPlan) en informe de asistencias
   Ejecutar después de los scripts de 06_07_2026 (especialmente el 10)
   Fecha: 08/07/2026
   ============================================================================ */
...
SELECT 'usp_asistencia_informe: filtro opcional p_IDPlan agregado.';
END$$
