-- Convertido automáticamente desde db_scripts/08_07_2026/3.usp_asistencia_informe_faltas_desde_membresia.sql
-- MySQL 8 — Academia 3.0

USE `AcademiaDB`;

/* ============================================================================
   Alter: FECHA_INICIO_MEM para faltas solo desde inicio de membresía
   Ejecutar después de 2.usp_asistencia_informe_filtro_estado.sql
   Fecha: 08/07/2026
   ============================================================================ */
...
SELECT 'usp_asistencia_informe: FECHA_INICIO_MEM para cómputo de faltas.';
END$$
