...
BEGIN
    ...
    PRINT 'SUB014 (Biblioteca) creado.';
END
ELSE
BEGIN
    ...
    PRINT 'SUB014 (Biblioteca) actualizado.';
END
GO
...
BEGIN
    ...
    PRINT 'SUB015 (Exámenes) actualizado.';
END
GO
...
BEGIN
    ...
    PRINT 'SUB016 (Horario) actualizado.';
END
GO
...
BEGIN
    ...
    PRINT 'SUB017 (Clases) actualizado.';
END
GO
...
PRINT 'Submódulos Académico: Biblioteca, Exámenes, Horario, Clases listos.';
GO
