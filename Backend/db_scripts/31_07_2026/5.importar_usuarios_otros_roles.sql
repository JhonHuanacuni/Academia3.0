...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 10033907: ' + @M; ELSE PRINT 'ERROR DNI 10033907: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 41591259: ' + @M; ELSE PRINT 'ERROR DNI 41591259: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 47047653: ' + @M; ELSE PRINT 'ERROR DNI 47047653: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 72618032: ' + @M; ELSE PRINT 'ERROR DNI 72618032: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 74806861: ' + @M; ELSE PRINT 'ERROR DNI 74806861: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 73878120: ' + @M; ELSE PRINT 'ERROR DNI 73878120: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 74176216: ' + @M; ELSE PRINT 'ERROR DNI 74176216: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 74806860: ' + @M; ELSE PRINT 'ERROR DNI 74806860: ' + @M;
GO
...
EXEC dbo.usp_usuario_insertar
    ...
    @Resultado          = @R OUTPUT,
    @Mensaje            = @M OUTPUT;
IF @R = 1 PRINT 'OK DNI 75234130: ' + @M; ELSE PRINT 'ERROR DNI 75234130: ' + @M;
GO
