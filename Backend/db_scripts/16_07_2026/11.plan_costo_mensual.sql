...
IF COL_LENGTH('PLAN', 'COSTOMENSUAL') IS NULL
BEGIN
    ALTER TABLE [PLAN] ADD COSTOMENSUAL DECIMAL(10,2) NULL;
    PRINT 'Columna PLAN.COSTOMENSUAL agregada.';
END
ELSE
    PRINT 'Columna PLAN.COSTOMENSUAL ya existe.';
GO
...
PRINT 'PLAN.COSTOMENSUAL y usp_plan_* actualizados.';
GO
