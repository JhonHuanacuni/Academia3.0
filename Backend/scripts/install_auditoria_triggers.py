...
Usado por setup_mysql_db.py y validate_mysql_scripts.py.
"""
...
def install_auditoria_triggers(cursor) -> None:
    """Crea triggers AFTER INSERT/UPDATE/DELETE por tabla vía cursor.execute (no PREPARE)."""
