export const usuarioConfig = {
  ...
  secciones: [
    ...
    },
    {
      ...
      soloTiposUsuario: ["1"],
      campos: [
        { campo: "NOMBREAPODERADO", etiqueta: "Nombre y apellido", control: "text", full: true, soloTiposUsuario: ["1"] },
        { campo: "TELAPODERADO", etiqueta: "Celular", control: "text", soloTiposUsuario: ["1"] },
        { campo: "PARENTESCO", etiqueta: "Parentesco", control: "text", soloTiposUsuario: ["1"] },
      ],
    },
    {
